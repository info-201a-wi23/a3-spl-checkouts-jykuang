...
- How was the data collected or generated?  
  - The data is generated through checkout data which comes from multiple historical and current sources. Additionally, usage data is provided by media vendors. Particular for historical physical item checkouts, the data is based on Legrady artwork data archives for checkouts between April 2005 and September 30, 2016. From forward October 2016 to present day, it's from Horizon ILS.
- Why was the data collected?  
  - The data was collected to record trends of library information. Trends such as noting the interest of what the communities they serve are checking out. 
...
- What are possible limitations or problems with this data?   (at least 200 words)
  - One limitations with the dataset is that there is inconsistency in the Creator column, where the name of the creator's full name can be printed backwards - such as last name coming before the first. While also, a printed year can be 
